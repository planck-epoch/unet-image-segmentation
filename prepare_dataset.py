...
def download_and_unzip():
    ...
    for link in download_links:
        ...
        if not os.path.exists(directory_name):
            if not os.path.isfile(full_filename):
                ...
                wget.download(link, full_filename)

            print("\nUnzip dataset... ", full_filename)
    ...
    print("MIDV-2019")
    for link in download_links_extra:
        filename = "midv2019_" + link[PATH_OFFSET_EXTRA:]
        full_filename = TARGET_PATH + filename
        directory_name = TARGET_PATH + "midv2019_" + link[PATH_OFFSET_EXTRA:-4]
