...
# USAGE: (https://www.tensorflow.org/lite/models/convert/metadata)
# $ python ./convert_model_add_metadata.py \
#     --model_file=./model.tflite \
#     --label_file=./labels.txt \
#     --export_directory=./outputs_model_metadata
...
_MODEL_INFO = {
    "model.tflite":
        ModelSpecificInfo(
            ...
            std=[127.5],
            num_classes=1,
            author="William Sousa  (wrs@sapo.pt)")
}
